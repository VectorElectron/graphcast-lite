...
| **Turbo 权重** (TensorRT端) | 0.25° 编译源包（含特定 ONNX 与 configs），用于全球极速生产推理 | [📥 下载 0.25° 编译包](https://github.com/VectorElectron/graphcast-lite/releases/download/weights/turbo_weights_0.25deg.tar.gz) |
